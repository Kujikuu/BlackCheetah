      ...
      <VCard>
        ...
        <VCardText v-if="selectedStaff" class="pa-6">
          <VRow>
            ...
            <VCol cols="12" md="6">
              <div class="text-body-2 text-disabled mb-1">Full Name</div>
              <div class="text-body-1 font-weight-medium">{{ selectedStaff.name }}</div>
            </VCol>
            <VCol cols="12" md="6">
              <div class="text-body-2 text-disabled mb-1">Email</div>
