        ...
        <VRow class="match-height">
          ...
          <VCol cols="12" md="7">
            <VCard>
              ...
              <VCardText>
                <p class="mb-6">
                  If you would like to discuss anything related to franchise management, pricing, features, or have
                  pre-sales questions, you're at the right place.
                </p>
                <VForm @submit.prevent="() => { }">
                  <VRow>
                    <VCol cols="12" md="6">
                      <AppTextField v-model="name" placeholder="Full Name" label="Full Name" />
                    </VCol>

                    <VCol cols="12" md="6">
                      <AppTextField v-model="email" placeholder="your@email.com" label="Email address" />
                    </VCol>

                    <VCol cols="12">
                      <AppTextarea v-model="message" placeholder="Your message" rows="3" label="Message" />
                    </VCol>
