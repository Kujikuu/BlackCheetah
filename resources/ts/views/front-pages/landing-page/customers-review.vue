...
const reviewData = [
  {
    ...
    position: 'CEO, Al-Noor Restaurants',
    avatar: avatar1,
  },
  {
    desc: 'The multi-role dashboard is brilliant. Our franchisees can track their performance while we maintain oversight of the entire network.',
    img: logo2,
    rating: 5,
    name: 'Fatima Al-Qahtani',
    position: 'Operations Director, Fitness Kingdom',
    avatar: avatar5,
  },
  {
    ...
    position: 'Founder, Quick Bites Franchises',
    avatar: avatar3,
  },
  {
    desc: 'The platform is intuitive and powerful. Our brokers love the lead management system, and we have complete visibility over all operations.',
    img: logo4,
    rating: 5,
    name: 'Sara Al-Mutairi',
    position: 'Franchise Director, TechHub KSA',
    avatar: avatar6,
  },
  {
    ...
    position: 'Managing Director, Coffee Corner',
    avatar: avatar3,
  },
  {
    desc: 'BlackCheetah transformed how we manage our 50+ franchise locations. Lead tracking and financial reporting have never been easier.',
      ...
      <VContainer>
        ...
        <div class="swiper-brands-carousel">
          <swiper-container slides-per-view="2" :space-between="10" events-prefix="swiper-" :autoplay="{
            ...
            <swiper-slide v-for="(img, index) in [brandLogo1, brandLogo2, brandLogo3, brandLogo4, brandLogo5]"
              :key="index">
