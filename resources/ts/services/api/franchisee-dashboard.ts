...
export class FranchiseeDashboardApi {
  ...
  async getFinancialOverview(): Promise<ApiResponse<FinancialOverviewData>> {
    return await $api<ApiResponse<FinancialOverviewData>>(`${this.getBaseUrl()}/dashboard/financial-overview`)
  }
  ...
  async addFinancialData(payload: AddFinancialDataPayload): Promise<ApiResponse<SalesRecord | ExpenseRecord>> {
    return await $api<ApiResponse<SalesRecord | ExpenseRecord>>(`${this.getBaseUrl()}/dashboard/financial-data`, {
      method: 'POST',
      body: payload,
    })
  }
  ...
  async updateFinancialData(id: string, payload: AddFinancialDataPayload): Promise<ApiResponse<SalesRecord | ExpenseRecord>> {
    return await $api<ApiResponse<SalesRecord | ExpenseRecord>>(`${this.getBaseUrl()}/dashboard/financial-data/${id}`, {
      method: 'PUT',
      body: payload,
    })
  }
  ...
  async deleteFinancialData(payload: DeleteFinancialDataPayload): Promise<ApiResponse<void>> {
    return await $api<ApiResponse<void>>(`${this.getBaseUrl()}/dashboard/financial-data`, {
      method: 'DELETE',
      body: payload,
    })
  }
  ...
  async getUnitDetails(unitId?: number): Promise<ApiResponse<UnitDetails>> {
    const url = unitId ? `${this.getBaseUrl()}/units/details/${unitId}` : `${this.getBaseUrl()}/units/details`
  ...
  async getUnitTasks(unitId?: number): Promise<ApiResponse<UnitTask[]>> {
    const url = unitId ? `${this.getBaseUrl()}/units/tasks/${unitId}` : `${this.getBaseUrl()}/units/tasks`
  ...
  async getMyTasks(): Promise<ApiResponse<UnitTask[]>> {
    return await $api<ApiResponse<UnitTask[]>>(`${this.getBaseUrl()}/my-tasks`)
  }

  // Update my task status
  async updateMyTaskStatus(taskId: number, status: string): Promise<ApiResponse<UnitTask>> {
    return await $api<ApiResponse<UnitTask>>(`${this.getBaseUrl()}/my-tasks/${taskId}/status`, {
      method: 'PATCH',
      body: { status },
    })
  }
  ...
  async getUnitStaff(unitId?: number): Promise<ApiResponse<UnitStaff[]>> {
    const url = unitId ? `${this.getBaseUrl()}/units/staff/${unitId}` : `${this.getBaseUrl()}/units/staff`
  ...
  async getUnitProducts(unitId?: number): Promise<ApiResponse<UnitProduct[]>> {
    const url = unitId ? `${this.getBaseUrl()}/units/products/${unitId}` : `${this.getBaseUrl()}/units/products`
  ...
  async getUnitReviews(unitId?: number): Promise<ApiResponse<UnitReview[]>> {
    const url = unitId ? `${this.getBaseUrl()}/units/reviews/${unitId}` : `${this.getBaseUrl()}/units/reviews`
  ...
  async getUnitDocuments(unitId?: number): Promise<ApiResponse<UnitDocument[]>> {
    const url = unitId ? `${this.getBaseUrl()}/units/documents/${unitId}` : `${this.getBaseUrl()}/units/documents`
  ...
  async updateUnitDetails(unitId: number, data: Partial<UnitDetails>): Promise<ApiResponse<UnitDetails>> {
    return await $api<ApiResponse<UnitDetails>>(`${this.getBaseUrl()}/units/details/${unitId}`, {
      method: 'PUT',
      body: data,
    })
  }
  ...
  async createTask(unitId: number, data: Omit<UnitTask, 'id'>): Promise<ApiResponse<UnitTask>> {
    return await $api<ApiResponse<UnitTask>>(`${this.getBaseUrl()}/units/tasks/${unitId}`, {
      method: 'POST',
      body: data,
    })
  }
  ...
  async updateTask(unitId: number, taskId: number, data: Partial<UnitTask>): Promise<ApiResponse<UnitTask>> {
    return await $api<ApiResponse<UnitTask>>(`${this.getBaseUrl()}/units/tasks/${unitId}/${taskId}`, {
      method: 'PUT',
      body: data,
    })
  }
  ...
  async deleteTask(unitId: number, taskId: number): Promise<ApiResponse<void>> {
    return await $api<ApiResponse<void>>(`${this.getBaseUrl()}/units/tasks/${unitId}/${taskId}`, {
      method: 'DELETE',
    })
  }
  ...
  async createStaff(unitId: number, data: Omit<UnitStaff, 'id'>): Promise<ApiResponse<UnitStaff>> {
    return await $api<ApiResponse<UnitStaff>>(`${this.getBaseUrl()}/units/staff/${unitId}`, {
      method: 'POST',
      body: data,
    })
  }
  ...
  async updateStaff(unitId: number, staffId: number, data: Partial<UnitStaff>): Promise<ApiResponse<UnitStaff>> {
    return await $api<ApiResponse<UnitStaff>>(`${this.getBaseUrl()}/units/staff/${unitId}/${staffId}`, {
      method: 'PUT',
      body: data,
    })
  }
  ...
  async deleteStaff(unitId: number, staffId: number): Promise<ApiResponse<void>> {
    return await $api<ApiResponse<void>>(`${this.getBaseUrl()}/units/staff/${unitId}/${staffId}`, {
      method: 'DELETE',
    })
  }
  ...
  async createProduct(unitId: number, data: Omit<UnitProduct, 'id'>): Promise<ApiResponse<UnitProduct>> {
    return await $api<ApiResponse<UnitProduct>>(`${this.getBaseUrl()}/units/products/${unitId}`, {
      method: 'POST',
      body: data,
    })
  }
  ...
  async updateProduct(unitId: number, productId: number, data: Partial<UnitProduct>): Promise<ApiResponse<UnitProduct>> {
    return await $api<ApiResponse<UnitProduct>>(`${this.getBaseUrl()}/units/products/${unitId}/${productId}`, {
      method: 'PUT',
      body: data,
    })
  }
  ...
  async deleteProduct(unitId: number, productId: number): Promise<ApiResponse<void>> {
    return await $api<ApiResponse<void>>(`${this.getBaseUrl()}/units/products/${unitId}/${productId}`, {
      method: 'DELETE',
    })
  }
  ...
  async createReview(unitId: number, data: Omit<UnitReview, 'id'>): Promise<ApiResponse<UnitReview>> {
    return await $api<ApiResponse<UnitReview>>(`${this.getBaseUrl()}/units/reviews/${unitId}`, {
      method: 'POST',
      body: data,
    })
  }
  ...
  async updateReview(unitId: number, reviewId: number, data: Partial<UnitReview>): Promise<ApiResponse<UnitReview>> {
    return await $api<ApiResponse<UnitReview>>(`${this.getBaseUrl()}/units/reviews/${unitId}/${reviewId}`, {
      method: 'PUT',
      body: data,
    })
  }
  ...
  async deleteReview(unitId: number, reviewId: number): Promise<ApiResponse<void>> {
    return await $api<ApiResponse<void>>(`${this.getBaseUrl()}/units/reviews/${unitId}/${reviewId}`, {
      method: 'DELETE',
    })
  }
  ...
  async createDocument(unitId: number, data: Omit<UnitDocument, 'id'> | FormData): Promise<ApiResponse<UnitDocument>> {
    return await $api<ApiResponse<UnitDocument>>(`${this.getBaseUrl()}/units/documents/${unitId}`, {
      method: 'POST',
      body: data,
    })
  }
  ...
  async updateDocument(unitId: number, documentId: number, data: Partial<UnitDocument>): Promise<ApiResponse<UnitDocument>> {
    return await $api<ApiResponse<UnitDocument>>(`${this.getBaseUrl()}/units/documents/${unitId}/${documentId}`, {
      method: 'PUT',
      body: data,
    })
  }
  ...
  async deleteDocument(unitId: number, documentId: number): Promise<ApiResponse<void>> {
    return await $api<ApiResponse<void>>(`${this.getBaseUrl()}/units/documents/${unitId}/${documentId}`, {
      method: 'DELETE',
    })
  }

  async downloadDocument(unitId: number, documentId: number): Promise<ApiResponse<{ url: string }>> {
    return await $api<ApiResponse<{ url: string }>>(`${this.getBaseUrl()}/units/documents/${unitId}/${documentId}/download`, {
      method: 'GET',
    })
  }
  ...
  async getAvailableFranchiseProducts(unitId: number): Promise<ApiResponse<UnitProduct[]>> {
    return await $api<ApiResponse<UnitProduct[]>>(`${this.getBaseUrl()}/units/available-products/${unitId}`, {
      method: 'GET',
    })
  }
  ...
  async addProductToInventory(unitId: number, data: { productId: number; quantity: number; reorderLevel: number }): Promise<ApiResponse<UnitProduct>> {
    return await $api<ApiResponse<UnitProduct>>(`${this.getBaseUrl()}/units/inventory/${unitId}`, {
      method: 'POST',
      body: data,
    })
  }
  ...
  async updateInventoryStock(unitId: number, productId: number, data: { quantity: number; reorderLevel?: number }): Promise<ApiResponse<void>> {
    return await $api<ApiResponse<void>>(`${this.getBaseUrl()}/units/inventory/${unitId}/${productId}`, {
      method: 'PUT',
      body: data,
    })
  }
...
export const franchiseeDashboardApi = new FranchiseeDashboardApi()
