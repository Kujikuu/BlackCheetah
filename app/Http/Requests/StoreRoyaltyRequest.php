...
class StoreRoyaltyRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'type' => ['required', 'string', 'in:royalty,marketing_fee,technology_fee,other'], // Accept transformed value
            ...
            'period_start_date' => ['nullable', 'date'], // Generated by prepareForValidation
            'period_end_date' => ['nullable', 'date'], // Generated by prepareForValidation
            'base_revenue' => ['required', 'numeric', 'min:0', 'max:999999999.99'],
            'gross_revenue' => ['nullable', 'numeric', 'min:0'], // Mapped from base_revenue
            'royalty_rate' => ['required', 'numeric', 'min:0', 'max:100'],
            'royalty_percentage' => ['nullable', 'numeric', 'min:0', 'max:100'], // Mapped from royalty_rate
            'marketing_fee_percentage' => ['nullable', 'numeric', 'min:0', 'max:100'], // Mapped from marketing_fee_rate
            'royalty_number' => ['nullable', 'string'], // Generated by prepareForValidation
